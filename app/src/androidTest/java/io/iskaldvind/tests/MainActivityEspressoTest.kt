...
class MainActivityEspressoTest {
    ...
    fun activitySearch_IsWorking() {
        ...
        onView(withId(R.id.totalCountTextView)).check(matches(withText(InstrumentationRegistry.getInstrumentation().targetContext.getString(R.string.test_value_espresso))))
